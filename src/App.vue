...
<template>
 <header :class="{'scrolled': isScrolled, 'menu-open': menuOpen}" class="header">
      <div class="header-content">
        <h1 :class="{'logo-black': isScrolled || menuOpen}" class="logo">
          <a href="/">Garden cafe</a>
        </h1>
  ...
  <RouterView />
  <footer
  class=" text-center w-full text-white text-surface/75 bg-[#2e3f15] lg:text-left">
  <div
    class="flex max-w-6xlitems-center justify-center border-b-2  p-6 border-white/10 lg:justify-between">
  ...
  <!-- Main container  -->
  <div class="mx-12 py-10 text-center flex justify-center md:text-left">
    <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
      <!-- Garden Cafe section -->
      <div class="">
        <h6
          class="mb-4  flex items-center justify-center font-semibold uppercase md:justify-start">
          <i class="fa-solid fa-mug-hot mr-2" style="color: #ffffff;"></i>
          Garden Cafe
        </h6>
        <p>
            From our locally sourced ingredients to our eco-friendly practices, we’re passionate about serving more than just great coffee — we’re creating connections.
        </p>
      </div>
      <!-- Menu section -->
      <div>
